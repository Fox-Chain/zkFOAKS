...
mod test {
    ...
    fn test_expander_init() {
        ...
        assert_eq!(220, unsafe { linear_pc.lce_ctx.expander_init(N / 128, None) });
    }
    ...
    fn test_encode() {
        ...
        println!("src with {} and encoded with {}", src.len(), encoded_codeword.len());

        assert_eq!(220, linear_pc.lce_ctx.encode(
            src,
            &mut encoded_codeword,
            128,
            Some(0)
        ));
    }
